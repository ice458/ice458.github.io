...
class ProjectManager:
    ...
    def validate_and_fix_links(self):
        ...
        for i, project in enumerate(self.projects):
            ...
            if existing_dir:
                expected_link = f"{existing_dir}/"
                article_file = self.html_file.parent / existing_dir / "index.html"
            else:
                expected_link = f"{project_slug}/"
    ...
    def generate_article_page(self):
        ...
        try:
            ...
            keywords = ','.join(project['categories']) + ',電子工作,製作物,DIY,ice458'
